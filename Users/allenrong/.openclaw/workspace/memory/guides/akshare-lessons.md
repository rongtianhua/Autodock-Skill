...
## 教训来源
2026-04-04 调试 akshare 东财/新浪/同花顺接口时的网络排查
...
### 反爬机制分析
1. **不是 TLS 指纹问题** — `curl_cffi` 模拟 Chrome 110~131/TLS 握手都通过，但 API 返回空或断连
...
| 模拟版本 | 结果 |
|---------|------|
| chrome110 | ❌ Connection closed abruptly |
| chrome120 | ❌ Connection closed abruptly |
| chrome124 | ❌ Connection closed abruptly |
| chrome131 | ❌ Connection closed abruptly |
| safari17_0 | ❌ Connection closed abruptly |
| 系统 curl | ✅ TLS 通，但返回空响应 |
