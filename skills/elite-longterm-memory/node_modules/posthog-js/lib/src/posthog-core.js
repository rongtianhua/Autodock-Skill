...
var PostHog = /** @class */ (function () {
    ...
    PostHog.prototype._handle_unload = function () {
        ...
        (_b = this._requestQueue) === null || _b === void 0 ? void 0 : _b.unload();
        (_c = this._retryQueue) === null || _c === void 0 ? void 0 : _c.unload();
    };
    ...
    PostHog.prototype.reset = function (reset_device_id) {
        ...
        (_f = this.persistence) === null || _f === void 0 ? void 0 : _f.set_property(constants_1.USER_STATE, constants_1.USER_STATE_ANONYMOUS);
        (_g = this.sessionManager) === null || _g === void 0 ? void 0 : _g.resetSessionId();
        this._cachedPersonProperties = null;
        if (this.config.cookieless_mode === constants_1.COOKIELESS_ALWAYS) {
            this.register_once({
                distinct_id: constants_1.COOKIELESS_SENTINEL_VALUE,
